...
flavor addfl[] = { { All, AnDirect, WL, arithReg, 0, 0xD0C0, 0xD1C0 }, // ADDA <ea>,An
...
flavor addafl[] = { { All, AnDirect, WL, arithReg, 0, 0xD0C0, 0xD1C0 }, };
...
flavor addxfl[] = { { DnDirect, DnDirect, BWL, twoReg, 0xD100, 0xD140, 0xD180 },
...
flavor aslfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE1C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE120, 0xE160, 0xE1A0 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE100, 0xE140, 0xE180 } };

flavor asrfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE0C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE020, 0xE060, 0xE0A0 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE000, 0xE040, 0xE080 } };

flavor bccfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6400, 0x6400, 0x6400 } };
...
flavor bcsfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6500, 0x6500, 0x6500 } };

flavor bfchgfl[] = { { DnControlAlt, 0, SHORT_SIZE | BWL, bitField, 0xEAC0,
		0xEAC0, 0xEAC0 } };

flavor bfclrfl[] = { { DnControlAlt, 0, SHORT_SIZE | BWL, bitField, 0xECC0,
		0xECC0, 0xECC0 } };

flavor bfextsfl[] = { { DnControl, DnDirect, SHORT_SIZE | BWL, bitField, 0xEBC0,
		0xEBC0, 0xEBC0 } };

flavor bfextufl[] = { { DnControl, DnDirect, SHORT_SIZE | BWL, bitField, 0xE9C0,
		0xE9C0, 0xE9C0 } };

flavor bfffofl[] = { { DnControl, DnDirect, SHORT_SIZE | BWL, bitField, 0xEDC0,
		0xEDC0, 0xEDC0 } };

flavor bfinsfl[] = { { DnDirect, DnControlAlt, SHORT_SIZE | BWL, bitField,
		0xEFC0, 0xEFC0, 0xEFC0 } };

flavor bfsetfl[] = { { DnControlAlt, 0, SHORT_SIZE | BWL, bitField, 0xEEC0,
		0xEEC0, 0xEEC0 } };

flavor bftstfl[] = { { DnControl, 0, SHORT_SIZE | BWL, bitField, 0xE8C0, 0xE8C0,
		0xE8C0 } };

flavor beqfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6700, 0x6700, 0x6700 } };

flavor bgefl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6C00, 0x6C00, 0x6C00 } };

flavor bgtfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6E00, 0x6E00, 0x6E00 } };

flavor bhifl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6200, 0x6200, 0x6200 } };

flavor bhsfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6400, 0x6400, 0x6400 } };

flavor blefl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6f00, 0x6F00, 0x6F00 } };

flavor blofl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6500, 0x6500, 0x6500 } };

flavor blsfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6300, 0x6300, 0x6300 } };

flavor bltfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6d00, 0x6D00, 0x6D00 } };

flavor bmifl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6b00, 0x6B00, 0x6B00 } };

flavor bnefl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6600, 0x6600, 0x6600 } };

flavor bplfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6a00, 0x6A00, 0x6A00 } };

flavor brafl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6000, 0x6000, 0x6000 } };
...
flavor bsrfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6100, 0x6100, 0x6100 } };
...
flavor bvcfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6800, 0x6800, 0x6800 } };

flavor bvsfl[] = { { Absolute, 0, SHORT_SIZE | LONG_SIZE | BYTE_SIZE
		| WORD_SIZE, branch, 0x6900, 0x6900, 0x6900 } };

flavor chkfl[] = { { Data, DnDirect, WORD_SIZE, arithReg, 0, 0x4180, 0 } };

flavor clrfl[] = { { DataAlt, 0, BWL, oneOp, 0x4200, 0x4240, 0x4280 } };

flavor cmpfl[] = { { Data, DnDirect, BWL, arithReg, 0xB000, 0xB040, 0xB080 }, {
		AnDirect, DnDirect, WL, arithReg, 0xB000, 0xB040, 0xB080 }, { All,
		AnDirect, WL, arithReg, 0, 0xB0C0, 0xB1C0 }, { IMMEDIATE, DataAlt, BWL,
		immedInst, 0x0C00, 0x0C40, 0x0C80 }, { AnIndPost, AnIndPost, BWL,
		twoReg, 0xB108, 0xB148, 0xB188 } };

flavor cmpafl[] = { { All, AnDirect, WL, arithReg, 0, 0xB0C0, 0xB1C0 } };
...
flavor dbccfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x54C8, 0 } };

flavor dbcsfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x55C8, 0 } };

flavor dbeqfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x57C8, 0 } };

flavor dbffl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x51C8, 0 } };

flavor dbgefl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5CC8, 0 } };

flavor dbgtfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5EC8, 0 } };

flavor dbhifl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x52C8, 0 } };

flavor dbhsfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x54C8, 0 } };

flavor dblefl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5FC8, 0 } };

flavor dblofl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x55C8, 0 } };

flavor dblsfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x53C8, 0 } };

flavor dbltfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5DC8, 0 } };

flavor dbmifl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5BC8, 0 } };

flavor dbnefl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x56C8, 0 } };

flavor dbplfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x5AC8, 0 } };

flavor dbrafl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x51C8, 0 } };

flavor dbtfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x50C8, 0 } };

flavor dbvcfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x58C8, 0 } };

flavor dbvsfl[] = { { DnDirect, Absolute, WORD_SIZE, dbcc, 0, 0x59C8, 0 } };

flavor divsfl[] = { { Data, DnDirect, WORD_SIZE, arithReg, 0, 0x81C0, 0 } };

flavor divufl[] = { { Data, DnDirect, WORD_SIZE, arithReg, 0, 0x80C0, 0 } };
...
flavor illegalfl[] = { { 0, 0, 0, zeroOp, 0, 0x4AFC, 0 } };

flavor jmpfl[] = { { Control, 0, 0, oneOp, 0, 0x4EC0, 0 } };

flavor jsrfl[] = { { Control, 0, 0, oneOp, 0, 0x4E80, 0 } };
...
flavor lslfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE3C0, 0 }, { DnDirect,
		...
		DnDirect, BWL, shiftReg, 0xE108, 0xE148, 0xE188 } };

flavor lsrfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE2C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE028, 0xE068, 0xE0A8 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE008, 0xE048, 0xE088 } };
...
//	{ CCRDirect, DataAlt, WORD_SIZE, moveReg, 0, 0x42C0, 0 },
		{ SRDirect, DataAlt, WORD_SIZE, moveReg, 0, 0x40C0, 0 }, { AnDirect,
				...
				AnDirect, LONG_SIZE, moveUSP, 0, 0x4E68, 0x4E68 } };

flavor moveafl[] = { { All, AnDirect, WL, move, 0, 0x3000, 0x2000 } };
...
flavor mulsfl[] = { { Data, DnDirect, WORD_SIZE, arithReg, 0, 0xC1C0, 0 } };

flavor mulufl[] = { { Data, DnDirect, WORD_SIZE, arithReg, 0, 0xC0C0, 0 } };

flavor nbcdfl[] = { { DataAlt, 0, BYTE_SIZE, oneOp, 0x4800, 0x4800, 0 } };

flavor negfl[] = { { DataAlt, 0, BWL, oneOp, 0x4400, 0x4440, 0x4480 } };

flavor negxfl[] = { { DataAlt, 0, BWL, oneOp, 0x4000, 0x4040, 0x4080 } };

flavor nopfl[] = { { 0, 0, 0, zeroOp, 0, 0x4E71, 0 } };

flavor notfl[] = { { DataAlt, 0, BWL, oneOp, 0x4600, 0x4640, 0x4680 } };
...
flavor peafl[] = { { Control, 0, LONG_SIZE, oneOp, 0, 0x4840, 0x4840 } };

flavor resetfl[] = { { 0, 0, 0, zeroOp, 0, 0x4E70, 0 } };

flavor rolfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE7C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE138, 0xE178, 0xE1B8 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE118, 0xE158, 0xE198 } };

flavor rorfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE6C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE038, 0xE078, 0xE0B8 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE018, 0xE058, 0xE098 } };

flavor roxlfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE5C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE130, 0xE170, 0xE1B0 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE110, 0xE150, 0xE190 } };

flavor roxrfl[] = { { MemAlt, 0, WORD_SIZE, oneOp, 0, 0xE4C0, 0 }, { DnDirect,
		DnDirect, BWL, shiftReg, 0xE030, 0xE070, 0xE0B0 }, { IMMEDIATE,
		DnDirect, BWL, shiftReg, 0xE010, 0xE050, 0xE090 } };

//flavor rtdfl[] = {
//	{ IMMEDIATE, 0, 0, immedWord, 0, 0x4E74, 0 }
//       };

flavor rtefl[] = { { 0, 0, 0, zeroOp, 0, 0x4E73, 0 } };

flavor rtrfl[] = { { 0, 0, 0, zeroOp, 0, 0x4E77, 0 } };

flavor rtsfl[] = { { 0, 0, 0, zeroOp, 0, 0x4E75, 0 } };

flavor sbcdfl[] = {
		{ DnDirect, DnDirect, BYTE_SIZE, twoReg, 0x8100, 0x8100, 0 }, {
				AnIndPre, AnIndPre, BYTE_SIZE, twoReg, 0x8108, 0x8108, 0 } };

flavor sccfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x54C0, 0x54C0, 0 } };

flavor scsfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x55C0, 0x55C0, 0 } };

flavor seqfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x57C0, 0x57C0, 0 } };

flavor sffl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x51C0, 0x51C0, 0 } };

flavor sgefl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5CC0, 0x5CC0, 0 } };

flavor sgtfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5EC0, 0x5EC0, 0 } };

flavor shifl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x52C0, 0x52C0, 0 } };

flavor shsfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x54C0, 0x54C0, 0 } };

flavor slefl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5FC0, 0x5FC0, 0 } };

flavor slofl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x55C0, 0x55C0, 0 } };

flavor slsfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x53C0, 0x53C0, 0 } };

flavor sltfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5DC0, 0x5DC0, 0 } };

flavor smifl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5BC0, 0x5BC0, 0 } };

flavor snefl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x56C0, 0x56C0, 0 } };

flavor splfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x5AC0, 0x5AC0, 0 } };

flavor stfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x50C0, 0x50C0, 0 } };

flavor stopfl[] = { { IMMEDIATE, 0, 0, immedWord, 0, 0x4E72, 0 } };

flavor subfl[] = { { All, AnDirect, WL, arithReg, 0, 0x90C0, 0x91C0 }, // changed order to match addfl CK 5/22/07
...
flavor subxfl[] = { { DnDirect, DnDirect, BWL, twoReg, 0x9100, 0x9140, 0x9180 },
		{ AnIndPre, AnIndPre, BWL, twoReg, 0x9108, 0x9148, 0x9188 } };

flavor svcfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x58C0, 0x58C0, 0 } };

flavor svsfl[] = { { DataAlt, 0, BYTE_SIZE, scc, 0x59C0, 0x59C0, 0 } };

flavor swapfl[] = { { DnDirect, 0, WORD_SIZE, oneReg, 0, 0x4840, 0 } };

flavor tasfl[] = { { DataAlt, 0, BYTE_SIZE, oneOp, 0x4AC0, 0x4AC0, 0 } };

flavor trapfl[] = { { IMMEDIATE, 0, 0, trap, 0, 0x4E40, 0 } };

flavor trapvfl[] = { { 0, 0, 0, zeroOp, 0, 0x4E76, 0 } };

flavor tstfl[] = { { DataAlt, 0, BWL, oneOp, 0x4A00, 0x4A40, 0x4A80 } };

flavor unlkfl[] = { { AnDirect, 0, 0, oneReg, 0, 0x4E58, 0 } };
...
instruction instTable[] = { { "ABCD", abcdfl, flavorCount(abcdfl), true, NULL },
		{ "ADD", addfl, flavorCount(addfl), true, NULL }, { "ADDA", addafl,
				flavorCount(addafl), true, NULL }, { "ADDI", addifl,
				flavorCount(addifl), true, NULL }, { "ADDQ", addqfl,
				flavorCount(addqfl), true, NULL }, { "ADDX", addxfl,
				flavorCount(addxfl), true, NULL }, { "AND", andfl, flavorCount(
				andfl), true, NULL }, { "ANDI", andifl, flavorCount(andifl),
				true, NULL }, { "ASL", aslfl, flavorCount(aslfl), true, NULL },
		{ "ASR", asrfl, flavorCount(asrfl), true, NULL }, { "BCC", bccfl,
				flavorCount(bccfl), true, NULL }, { "BCHG", bchgfl, flavorCount(
				bchgfl), true, NULL }, { "BCLR", bclrfl, flavorCount(bclrfl),
				true, NULL }, { "BCS", bcsfl, flavorCount(bcsfl), true, NULL },
		{ "BEQ", beqfl, flavorCount(beqfl), true, NULL }, { "BFCHG", bfchgfl,
				flavorCount(bfchgfl), true, NULL }, { "BFCLR", bfclrfl,
				flavorCount(bfclrfl), true, NULL }, { "BFEXTS", bfextsfl,
				flavorCount(bfextsfl), true, NULL }, { "BFEXTU", bfextufl,
				flavorCount(bfextufl), true, NULL }, { "BFFFO", bfffofl,
				flavorCount(bfffofl), true, NULL }, { "BFINS", bfinsfl,
				flavorCount(bfinsfl), true, NULL }, { "BFSET", bfsetfl,
		...
		NULL }, { "CLR", clrfl, flavorCount(clrfl), true, NULL }, { "CMP",
				...
				flavorCount(dbcsfl), true, NULL }, { "DBEQ", dbeqfl,
				flavorCount(dbeqfl), true, NULL }, { "DBF", dbffl, flavorCount(
				dbffl), true, NULL }, { "DBGE", dbgefl, flavorCount(dbgefl),
				true, NULL },
		{ "DBGT", dbgtfl, flavorCount(dbgtfl), true, NULL }, { "DBHI", dbhifl,
				flavorCount(dbhifl), true, NULL }, { "DBHS", dbccfl,
				flavorCount(dbccfl), true, NULL }, { "DBLE", dblefl,
		...
		NULL }, { "DBLT", dbltfl, flavorCount(dbltfl), true, NULL }, { "DBMI",
				...
				true, NULL },
		{ "DBVS", dbvsfl, flavorCount(dbvsfl), true, NULL }, { "DC", NULL, 0,
				false, dc }, { "DCB", NULL, 0, false, dcb }, { "DIVS", divsfl,
				flavorCount(divsfl), true, NULL }, { "DIVU", divufl,
		...
		{ "LSL", lslfl, flavorCount(lslfl), true, NULL }, { "LSR", lsrfl,
				...
				flavorCount(moveafl), true, NULL },
		//{ "MOVEC", movecfl, flavorCount(movecfl), true, NULL },
		{ "MOVEM", movefl, 0, false, movem }, // movefl is only used for syntax highlighting
		{ "MOVEP", movepfl, flavorCount(movepfl), true, NULL }, { "MOVEQ",
				moveqfl, flavorCount(moveqfl), true, NULL },
		//{ "MOVES", movesfl, flavorCount(movesfl), true, NULL },
		{ "MULS", mulsfl, flavorCount(mulsfl), true, NULL }, { "MULU", mulufl,
				flavorCount(mulufl), true, NULL }, { "NBCD", nbcdfl,
				flavorCount(nbcdfl), true, NULL }, { "NEG", negfl, flavorCount(
				negfl), true, NULL }, { "NEGX", negxfl, flavorCount(negxfl),
				true, NULL }, { "NOLIST", NULL, 0, false, listOff }, { "NOP",
				nopfl, flavorCount(nopfl), true, NULL }, { "NOT", notfl,
				flavorCount(notfl), true, NULL }, { "OFFSET", NULL, 0, false,
				offset }, { "OPT", NULL, 0, false, opt }, { "OR", orfl,
				flavorCount(orfl), true, NULL }, { "ORG", NULL, 0, false, org },
		{ "ORI", orifl, flavorCount(orifl), true, NULL }, { "PAGE", NULL, 0,
				false, page }, { "PEA", peafl, flavorCount(peafl), true, NULL },
		...
		{ "RTE", rtefl, flavorCount(rtefl), true, NULL }, { "RTR", rtrfl,
				...
				rtsfl), true, NULL }, { "SBCD", sbcdfl, flavorCount(sbcdfl),
				true, NULL }, { "SCC", sccfl, flavorCount(sccfl), true, NULL },
		{ "SCS", scsfl, flavorCount(scsfl), true, NULL }, { "SECTION", NULL, 0,
				false, section },
		{ "SEQ", seqfl, flavorCount(seqfl), true, NULL }, { "SET", NULL, 0,
				false, set }, { "SF", sffl, flavorCount(sffl), true, NULL }, {
		...
		{ "UNLESS", NULL, 0, false, asmStructure }, { "UNLK", unlkfl,
				flavorCount(unlkfl), true, NULL }, { "UNTIL", NULL, 0, false,
				asmStructure }, { "WHILE", NULL, 0, false, asmStructure } };
