...
testSrc/%.o: ../testSrc/%.cpp testSrc/subdir.mk
	...
	g++ -o "$@" "$<" -std=c++2a -DTESTINGON=TESTINGON -I/usr/local/include/wx-3.0 -I/usr/local/include -I/usr/include -I/usr/local/lib/wx/include/gtk2-unicode-3.0 -O0 -g3 -Wall -c -fmessage-length=0  `wx-config --cppflags` -v -fPIC -pthread -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"
